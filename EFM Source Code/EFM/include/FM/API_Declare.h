...
#ifdef FM_EXPORTS
#define EXPORT_ED_FM_PHYSICS_IMP __declspec(dllexport)
#else
#define EXPORT_ED_FM_PHYSICS_IMP __declspec(dllimport)
#endif
...
extern "C" 
{
	...
	*/
	EXPORT_ED_FM_PHYSICS_IMP void ed_fm_set_draw_args_v2(float* array, size_t size);
	EXPORT_ED_FM_PHYSICS_IMP void ed_fm_set_fc3_cockpit_draw_args_v2(float* array, size_t size);
