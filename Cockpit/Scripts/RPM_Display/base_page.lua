...
function addSegment(side, pos, param, minVal, maxVal, material)
	...
	element.controllers  	= {{"parameter_in_range",0, minVal-0.1,maxVal}}
...
for i = 10,40,10  do -- 0-40 (10% increment)
	addSegment('L',i/10*segmentSize, {"N2_RPM"}, i, 96,redMat)
	addSegment('R',i/10*segmentSize, {"NR_RPM"}, i, 87,redMat)
end
for i = 60,80,20 do -- 40-80 (20% increment)
	addSegment('L',2*segmentSize+i/20*segmentSize, {"N2_RPM"}, i, 96,redMat)
	addSegment('R',2*segmentSize+i/20*segmentSize, {"NR_RPM"}, i, 87,redMat)
end
for i = 87,109,1 do -- 87-109 (1% increment)
	...
	addSegment('L',-80*segmentSize+i*segmentSize, {"N2_RPM"}, i, maxVal, mat)
	
	mat = greenMat
	if i>=107 then mat=redMat end
	addSegment('R',-80*segmentSize+i*segmentSize, {"NR_RPM"}, i, 130, mat)
end
