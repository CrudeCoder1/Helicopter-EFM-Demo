...
AH6 = {
	Name				=	'AH-6', -- unique name internal to DCS
	...
	lights_data = {
		typename = "collection",
		lights = {
		[1] = { -- strobe/anti-collision lights
			typename = "collection",
			lights = {--[1] = {typename = "omnilight", connector = "RED_BEACON", color = {0.99, 0.11, 0.3}, pos_correction  = {0, 0, 0}, intensity_max = 6.0},
					}
		},
		[2] = { -- taxi/landing lights
			typename = "collection",
			lights = {{typename  = "argumentlight",	argument  = 208},}
		},
		[3]	= {	-- position/nav lights
			typename = "collection",
			lights = {{typename = "argumentlight", argument  = 190},}
		},
		[4] = {	-- formation lights
			typename = "collection",
			lights = {--[1] = {typename  = "argumentlight", argument = 200},
					}
		},
		}
	},
